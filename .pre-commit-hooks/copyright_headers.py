#!/usr/bin/env python3
# Copyright 2021-2024 Broadcom Corporation
...
COPYRIGHT_HEADER = "# Copyright {year} Broadcom Corporation"
COPYRIGHT_REGEX = re.compile(
    r"# Copyright (?:(?P<start_year>[0-9]{4})(?:-(?P<cur_year>[0-9]{4}))?) Broadcom Corporation"
)
